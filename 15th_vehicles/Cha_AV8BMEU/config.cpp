...
class CfgPatches
{
	class Cha_AV8BMEU
	{
		units[] = {"Cha_AV8B","Cha_AV8B2","Cha_AV8B3","Cha_AV8BWreck"};
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_Air_F","A3_Weapons_F","Cha_AV8B"};
		magazines[] = {};
		ammo[] = {"Cha_B_25mm"};
	};
};
...
class CfgMagazines
{
	...
	class Cha_300Rnd_25mm_shells_T: 300Rnd_25mm_shells
	{
		ammo = "Cha_B_25mm";
		tracersevery = 1;
		nvgOnly = 0;
	...
	class Cha_4Rnd_GBU12_LGB: 2Rnd_GBU12_LGB
	{
		count = 4;
	};
	class 24Rnd_Missiles;
	class Cha_14Rnd_Rockets: 24Rnd_Missiles
	{
		count = 14;
	};
...
class CfgWeapons
{
	...
	class Cha_gatling_25mm: gatling_25mm
	{
		magazines[] = {"Cha_300Rnd_25mm_shells_T"};
		class manual: manual
		{
	...
	class Cha_Maverick_F: Missile_AGM_02_Plane_CAS_01_F
	{
		magazines[] = {"Cha_2Rnd_Missile_AGM_02_F"};
		displayname = "AGM-65 Maverick";
	};
	class GBU12BombLauncher;
	class Cha_GBU12BombLauncher: GBU12BombLauncher
	{
		magazines[] = {"2Rnd_GBU12_LGB","2Rnd_GBU12_LGB_MI10","Cha_4Rnd_GBU12_LGB"};
	};
	class rocketpods;
	...
	class Cha_Sidewinder_Lnc: Missile_AA_04_Plane_CAS_01_F
	{
		displayname = "AIM-9 Sidewinder";
	};
	class missiles_Zephyr;
	class Cha_AMRAAM: missiles_Zephyr
	{
		displayname = "AMRAAM";
	};
};
class CfgVehicles
{
	...
	class Cha_AV8B2: Plane
	{
		...
		model = "\cha\cha_av8b\av8b2";
		picture = "\cha\cha_av8b\data\ui\av8b_CA.paa";
		Icon = "\cha\cha_av8b\data\ui\icomap_AV8B_CA.paa";
		mapSize = 14;
		side = 1;
		faction = "BLU_F";
		...
		dammageHalf[] = {"\Cha\Cha_AV8B\data\ah1z_monitor_glass_ca.paa","\Cha\Cha_AV8B\data\ah1z_monitor_glass_destr_co.paa"};
		dammageFull[] = {"\Cha\Cha_AV8B\data\ah1z_monitor_glass_ca.paa","\Cha\Cha_AV8B\data\ah1z_monitor_glass_destr_co.paa"};
		class Damage
		{
			tex[] = {};
			mat[] = {"cha\cha_av8b\data\av8b_glass.rvmat","cha\cha_av8b\data\av8b_glass_damage.rvmat","cha\cha_av8b\data\av8b_glass_damage.rvmat","cha\cha_av8b\data\av8b_glass_in.rvmat","cha\cha_av8b\data\av8b_glass_in_damage.rvmat","cha\cha_av8b\data\av8b_glass_in_damage.rvmat","cha\cha_av8b\data\av8b_int.rvmat","cha\cha_av8b\data\av8b_int.rvmat","cha\cha_av8b\data\av8b_int_destruct.rvmat","cha\cha_av8b\data\av8b_ext.rvmat","cha\cha_av8b\data\av8b_ext_damage.rvmat","cha\cha_av8b\data\av8b_ext_destruct.rvmat"};
		};
		dustEffect = "HeliDust";
	...
	class Cha_AV8B: Cha_AV8B2
	{
		model = "\cha\cha_av8b\av8b";
	...
	class Cha_AV8B3: Cha_AV8B2
	{
		model = "\cha\cha_av8b\av8b3";
	...
	class Cha_AV8BWreck: PlaneWreck
	{
		scope = 1;
		class Armory
		{
