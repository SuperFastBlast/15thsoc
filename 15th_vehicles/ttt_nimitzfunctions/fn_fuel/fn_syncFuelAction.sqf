private ["_unit", "_pos", "_msg", "_nimCar2", "_hose1Pos", "_hose2Pos",
	 "_nimspots", "_dir"];
...
_pos = position _unit;
_hose1Pos = _nimCar2 modelToWorld(_nimCar2 selectionPosition "fuelHose1pos");
// not used right now
_hose2Pos = _nimCar2 modelToWorld(_nimCar2 selectionPosition "fuelHose2pos");
