	...
	CreateDialog "FA18_E_LOADOUTS_UI";
		...
		"FUEL TANK"
	 	...
	 	((uiNamespace getVariable "myDisplay") displayCtrl 3105) ctrlSetEventHandler ["LBSelChanged","[_F35]Spawn JS_JC_fnc_F35_E_LOADOUT_RESTRICTIONS_3105"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3106) ctrlSetEventHandler ["LBSelChanged","[_F35]Spawn JS_JC_fnc_F35_E_LOADOUT_RESTRICTIONS_3106"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3107) ctrlSetEventHandler ["LBSelChanged","[_F35]Spawn JS_JC_fnc_F35_E_LOADOUT_RESTRICTIONS_3107"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3108) ctrlSetEventHandler ["LBSelChanged","[_F35]Spawn JS_JC_fnc_F35_E_LOADOUT_RESTRICTIONS_3108"];
