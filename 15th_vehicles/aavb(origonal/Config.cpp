...
class CfgVehicles
{
	...
	class Tracked_APC:Wheeled_APC_F
	{};
	class AAV: Tracked_APC
	{
		...
		canFloat = true;
		supplyRadius = 5;
		wheelCircumference=2.2; // 304.8mm radius
		textureTrackWheel = "";
		hiddenSelections[] =
		{
			"Camo1",
		...
		enginePower = 400; // 22999.998 origin mass
		maxOmega = 293.22;
		peakTorque = 1118;
		torqueCurve[] = {
		{"0/2800" , "0/1118"},
		...
		/*
		The following Section is all the things i will add
		to try to get the Amphibious portion working by integrating 
		The Car features while perserving the TankX simulation.
		*/
		//ITG_Start
	...
	class complexGearbox {
			GearboxRatios[]    = {"R2",-1.5,"N",0,"D1",1.460,"D2",0.967,"D3",0.678,"D4",0.461,"D5",0.300,"D6",0.200,"D7",0.153,"D8",0.093};
...
class Wheels {
	class L2 {
			...
			sprungMass = 1585;
			springStrength = 39614;
			springDamperRate = 6339;
			dampingRate = 1;
