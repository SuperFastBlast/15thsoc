			...
			class HUD_2 {
				...
				class Draw {
					...
					class PlaneMovementCrosshair {
						...
						type = "line";
						width = 6;
						points[] = {{"Velocity", {0 *2 /3, -0.02 *2 /3}, 1}, {"Velocity", {0.0099999998 *2 /3, -0.01732 *2 /3}, 1}, {"Velocity", {0.01732 *2 /3, -0.0099999998 *2 /3}, 1}, {"Velocity", {0.02 *2 /3, 0 *2 /3}, 1}, {"Velocity", {0.01732 *2 /3, 0.0099999998 *2 /3}, 1}, {"Velocity", {0.0099999998 *2 /3, 0.01732 *2 /3}, 1}, {"Velocity", {0 *2 /3, 0.02 *2 /3}, 1}, {"Velocity", {-0.0099999998 *2 /3, 0.01732 *2 /3}, 1}, {"Velocity", {-0.01732 *2 /3, 0.0099999998 *2 /3}, 1}, {"Velocity", {-0.02 *2 /3, 0 *2 /3}, 1}, {"Velocity", {-0.01732 *2 /3, -0.0099999998 *2 /3}, 1}, {"Velocity", {-0.0099999998 *2 /3, -0.01732 *2 /3}, 1}, {"Velocity", {0 *2 /3, -0.02 *2 /3}, 1}, {}, {"Velocity", {0.035, 0}, 1}, {"Velocity", {0.02 *2 /3, 0}, 1}, {}, {"Velocity", {-0.035, 0}, 1}, {"Velocity", {-0.02 *2 /3, 0}, 1}, {}, {"Velocity", {0, -0.039999999 *2 /3}, 1}, {"Velocity", {0, -0.02 *2 /3}, 1}};
					};
					...
					class RadarTargets {
						...
						pos10[] = {1.382, 1.145};
						width = 2.5;
						points[] = {{{-0.02, -0.02}, 1}, {{0.02, -0.02}, 1}, {{0.02, 0.02}, 1}, {{-0.02, 0.02}, 1}, {{-0.02, -0.02}, 1}};
					};
					...
					class AA_target {
						...
						class Target {
							type = "line";
							points[] = {{"TargetSelected", {0, -0.02}, 1}, {"TargetSelected", {0.01, -0.01732}, 1}, {"TargetSelected", {0.01732, -0.01}, 1}, {"TargetSelected", {0.02, 0}, 1}, {"TargetSelected", {0.01732, 0.01}, 1}, {"TargetSelected", {0.01, 0.01732}, 1}, {"TargetSelected", {0, 0.02}, 1}, {"TargetSelected", {-0.01, 0.01732}, 1}, {"TargetSelected", {-0.01732, 0.01}, 1}, {"TargetSelected", {-0.02, 0}, 1}, {"TargetSelected", {-0.01732, -0.01}, 1}, {"TargetSelected", {-0.01, -0.01732}, 1}, {"TargetSelected", {0, -0.02}, 1}};
						};
					};
					...
					class AG_target {
						...
						class Target {
							type = "line";
							points[] = {{"TargetSelected", {0, -0.02}, 1}, {"TargetSelected", {0.01, -0.01732}, 1}, {"TargetSelected", {0.01732, -0.01}, 1}, {"TargetSelected", {0.02, 0}, 1}, {"TargetSelected", {0.01732, 0.01}, 1}, {"TargetSelected", {0.01, 0.01732}, 1}, {"TargetSelected", {0, 0.02}, 1}, {"TargetSelected", {-0.01, 0.01732}, 1}, {"TargetSelected", {-0.01732, 0.01}, 1}, {"TargetSelected", {-0.02, 0}, 1}, {"TargetSelected", {-0.01732, -0.01}, 1}, {"TargetSelected", {-0.01, -0.01732}, 1}, {"TargetSelected", {0, -0.02}, 1}, {}, {"TargetSelected", {0, -0.02}, 1}, {"TargetSelected", {0, -0.01}, 1}, {}, {"TargetSelected", {0, 0.02}, 1}, {"TargetSelected", {0, 0.01}, 1}, {}, {"TargetSelected", {0.02, 0}, 1}, {"TargetSelected", {0.01, 0}, 1}, {}, {"TargetSelected", {-0.02, 0}, 1}, {"TargetSelected", {-0.01, 0}, 1}};
						};
					};
					...
					class GUN_target {
						...
						class Target {
							type = "line";
							width = 4;
							points[] = {{"TargetSelected", {0, -0.03}, 1}, {"TargetSelected", {0, -0.025}, 1}, {}, {"TargetSelected", {0, -0.02}, 1}, {"TargetSelected", {0, -0.015}, 1}, {}, {"TargetSelected", {0, -0.01}, 1}, {"TargetSelected", {0, -0.005}, 1}, {}, {"TargetSelected", {0, 0}, 1}, {"TargetSelected", {0, 0}, 1}, {}, {"TargetSelected", {0, 0.03}, 1}, {"TargetSelected", {0, 0.025}, 1}, {}, {"TargetSelected", {0, 0.02}, 1}, {"TargetSelected", {0, 0.015}, 1}, {}, {"TargetSelected", {0, 0.01}, 1}, {"TargetSelected", {0, 0.005}, 1}, {}, {"TargetSelected", {-0.03, 0}, 1}, {"TargetSelected", {-0.025, 0}, 1}, {}, {"TargetSelected", {-0.02, 0}, 1}, {"TargetSelected", {-0.015, 0}, 1}, {}, {"TargetSelected", {-0.01, 0}, 1}, {"TargetSelected", {-0.005, 0}, 1}, {}, {"TargetSelected", {0.03, 0}, 1}, {"TargetSelected", {0.025, 0}, 1}, {}, {"TargetSelected", {0.02, 0}, 1}, {"TargetSelected", {0.015, 0}, 1}, {}, {"TargetSelected", {0.01, 0}, 1}, {"TargetSelected", {0.005, 0}, 1}, {}};
						};
					};
					...
					class GunCross {
						...
						class CCIP_circle {
							//type = "line";
						//	width = 5.0;
							//points[] = {{"WeaponAimGUN", {-1.2000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimGUN", {-1.0000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimGUN", {-0.9877 * 0.06, -0.1736 * 0.06}, 1}, {"WeaponAimGUN", {-0.9397 * 0.06, -0.3420 * 0.06}, 1}, {"WeaponAimGUN", {-0.8660 * 0.06, -0.5000 * 0.06}, 1}, {"WeaponAimGUN", {-0.7660 * 0.06, -0.6428 * 0.06}, 1}, {"WeaponAimGUN", {-0.6428 * 0.06, -0.7660 * 0.06}, 1}, {"WeaponAimGUN", {-0.5000 * 0.06, -0.8660 * 0.06}, 1}, {"WeaponAimGUN", {-0.3420 * 0.06, -0.9397 * 0.06}, 1}, {"WeaponAimGUN", {-0.1736 * 0.06, -0.9877 * 0.06}, 1}, {"WeaponAimGUN", {-0.0000 * 0.06, -1.0000 * 0.06}, 1}, {"WeaponAimGUN", {0.1736 * 0.06, -0.9877 * 0.06}, 1}, {"WeaponAimGUN", {0.3420 * 0.06, -0.9397 * 0.06}, 1}, {"WeaponAimGUN", {0.5000 * 0.06, -0.8660 * 0.06}, 1}, {"WeaponAimGUN", {0.6428 * 0.06, -0.7660 * 0.06}, 1}, {"WeaponAimGUN", {0.7660 * 0.06, -0.6428 * 0.06}, 1}, {"WeaponAimGUN", {0.8660 * 0.06, -0.5000 * 0.06}, 1}, {"WeaponAimGUN", {0.9397 * 0.06, -0.3420 * 0.06}, 1}, {"WeaponAimGUN", {0.9877 * 0.06, -0.1736 * 0.06}, 1}, {"WeaponAimGUN", {1.0000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimGUN", {1.2000 * 0.06, -0.0000 * 0.06}, 1}, {}, {"WeaponAimGUN", {-1.2000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimGUN", {-1.0000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimGUN", {-0.9877 * 0.06, 0.1736 * 0.06}, 1}, {"WeaponAimGUN", {-0.9397 * 0.06, 0.3420 * 0.06}, 1}, {"WeaponAimGUN", {-0.8660 * 0.06, 0.5000 * 0.06}, 1}, {"WeaponAimGUN", {-0.7660 * 0.06, 0.6428 * 0.06}, 1}, {"WeaponAimGUN", {-0.6428 * 0.06, 0.7660 * 0.06}, 1}, {"WeaponAimGUN", {-0.5000 * 0.06, 0.8660 * 0.06}, 1}, {"WeaponAimGUN", {-0.3420 * 0.06, 0.9397 * 0.06}, 1}, {"WeaponAimGUN", {-0.1736 * 0.06, 0.9877 * 0.06}, 1}, {"WeaponAimGUN", {-0.0000 * 0.06, 1.0000 * 0.06}, 1}, {"WeaponAimGUN", {0.1736 * 0.06, 0.9877 * 0.06}, 1}, {"WeaponAimGUN", {0.3420 * 0.06, 0.9397 * 0.06}, 1}, {"WeaponAimGUN", {0.5000 * 0.06, 0.8660 * 0.06}, 1}, {"WeaponAimGUN", {0.6428 * 0.06, 0.7660 * 0.06}, 1}, {"WeaponAimGUN", {0.7660 * 0.06, 0.6428 * 0.06}, 1}, {"WeaponAimGUN", {0.8660 * 0.06, 0.5000 * 0.06}, 1}, {"WeaponAimGUN", {0.9397 * 0.06, 0.3420 * 0.06}, 1}, {"WeaponAimGUN", {0.9877 * 0.06, 0.1736 * 0.06}, 1}, {"WeaponAimGUN", {1.0000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimGUN", {1.2000 * 0.06, 0.0000 * 0.06}, 1}, {}, {"WeaponAimGUN", {-0.0000 * 0.06, -1.0000 * 0.06}, 1}, {"WeaponAimGUN", {-0.0000 * 0.06, -1.2000 * 0.06}, 1}, {}, {"WeaponAimGUN", {-0.0000 * 0.06, 1.0000 * 0.06}, 1}, {"WeaponAimGUN", {-0.0000 * 0.06, 1.2000 * 0.06}, 1}, {}, {"WeaponAimGUN", {0.005, 0}, 1}, {"WeaponAimGUN", {-0.005, 0}, 1}, {}, {"WeaponAimGUN", {0, 0.005}, 1}, {"WeaponAimGUN", {0, -0.005}, 1}};
						};
					};
					...
					class RocketCross {
						...
						//	type = "line";
						//	width = 5.0;
						//	points[] = {{"WeaponAimROCKET", {-1.2000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-1.0000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.9877 * 0.06, -0.1736 * 0.06}, 1}, {"WeaponAimROCKET", {-0.9397 * 0.06, -0.3420 * 0.06}, 1}, {"WeaponAimROCKET", {-0.8660 * 0.06, -0.5000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.7660 * 0.06, -0.6428 * 0.06}, 1}, {"WeaponAimROCKET", {-0.6428 * 0.06, -0.7660 * 0.06}, 1}, {"WeaponAimROCKET", {-0.5000 * 0.06, -0.8660 * 0.06}, 1}, {"WeaponAimROCKET", {-0.3420 * 0.06, -0.9397 * 0.06}, 1}, {"WeaponAimROCKET", {-0.1736 * 0.06, -0.9877 * 0.06}, 1}, {"WeaponAimROCKET", {-0.0000 * 0.06, -1.0000 * 0.06}, 1}, {"WeaponAimROCKET", {0.1736 * 0.06, -0.9877 * 0.06}, 1}, {"WeaponAimROCKET", {0.3420 * 0.06, -0.9397 * 0.06}, 1}, {"WeaponAimROCKET", {0.5000 * 0.06, -0.8660 * 0.06}, 1}, {"WeaponAimROCKET", {0.6428 * 0.06, -0.7660 * 0.06}, 1}, {"WeaponAimROCKET", {0.7660 * 0.06, -0.6428 * 0.06}, 1}, {"WeaponAimROCKET", {0.8660 * 0.06, -0.5000 * 0.06}, 1}, {"WeaponAimROCKET", {0.9397 * 0.06, -0.3420 * 0.06}, 1}, {"WeaponAimROCKET", {0.9877 * 0.06, -0.1736 * 0.06}, 1}, {"WeaponAimROCKET", {1.0000 * 0.06, -0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {1.2000 * 0.06, -0.0000 * 0.06}, 1}, {}, {"WeaponAimROCKET", {-1.2000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-1.0000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.9877 * 0.06, 0.1736 * 0.06}, 1}, {"WeaponAimROCKET", {-0.9397 * 0.06, 0.3420 * 0.06}, 1}, {"WeaponAimROCKET", {-0.8660 * 0.06, 0.5000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.7660 * 0.06, 0.6428 * 0.06}, 1}, {"WeaponAimROCKET", {-0.6428 * 0.06, 0.7660 * 0.06}, 1}, {"WeaponAimROCKET", {-0.5000 * 0.06, 0.8660 * 0.06}, 1}, {"WeaponAimROCKET", {-0.3420 * 0.06, 0.9397 * 0.06}, 1}, {"WeaponAimROCKET", {-0.1736 * 0.06, 0.9877 * 0.06}, 1}, {"WeaponAimROCKET", {-0.0000 * 0.06, 1.0000 * 0.06}, 1}, {"WeaponAimROCKET", {0.1736 * 0.06, 0.9877 * 0.06}, 1}, {"WeaponAimROCKET", {0.3420 * 0.06, 0.9397 * 0.06}, 1}, {"WeaponAimROCKET", {0.5000 * 0.06, 0.8660 * 0.06}, 1}, {"WeaponAimROCKET", {0.6428 * 0.06, 0.7660 * 0.06}, 1}, {"WeaponAimROCKET", {0.7660 * 0.06, 0.6428 * 0.06}, 1}, {"WeaponAimROCKET", {0.8660 * 0.06, 0.5000 * 0.06}, 1}, {"WeaponAimROCKET", {0.9397 * 0.06, 0.3420 * 0.06}, 1}, {"WeaponAimROCKET", {0.9877 * 0.06, 0.1736 * 0.06}, 1}, {"WeaponAimROCKET", {1.0000 * 0.06, 0.0000 * 0.06}, 1}, {"WeaponAimROCKET", {1.2000 * 0.06, 0.0000 * 0.06}, 1}, {}, {"WeaponAimROCKET", {-0.0000 * 0.06, -1.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.0000 * 0.06, -1.2000 * 0.06}, 1}, {}, {"WeaponAimROCKET", {-0.0000 * 0.06, 1.0000 * 0.06}, 1}, {"WeaponAimROCKET", {-0.0000 * 0.06, 1.2000 * 0.06}, 1}, {}, {"WeaponAimROCKET", {0.005, 0}, 1}, {"WeaponAimROCKET", {-0.005, 0}, 1}, {}, {"WeaponAimROCKET", {0, 0.005}, 1}, {"WeaponAimROCKET", {0, -0.005}, 1}};
						};
					};
					...
					class AC_Centerline {
						...
						class RockCross {
							type = "line";
							width = 4;
							points[] = {{{ -0.006 + 0.5, 0 + 0.32}, 1}, {{ 0.006 + 0.5, 0 + 0.32}, 1}, {}, {{ -0.0 + 0.5, 0.006 + 0.32}, 1}, {{ 0.0 + 0.5, -0.006 + 0.32}, 1}};
						};
					};
					...
					class ILS_Bars {
						...
						class Glideslope {
							...
							class ILS {
								type = "line";
								width = 2.5;
								points[] = {{ILS_W, {-0.2, 0}, 1}, {ILS_W, {0.2, 0}, 1}, {}, {ILS_W, {0, 0.02}, 1}, {ILS_W, {0, -0.02}, 1}, {}, {ILS_W, {0.1, 0.02}, 1}, {ILS_W, {0.1, -0.02}, 1}, {}, {ILS_W, {0.2, 0.02}, 1}, {ILS_W, {0.2, -0.02}, 1}, {}, {ILS_W, {-0.1, 0.02}, 1}, {ILS_W, {-0.1, -0.02}, 1}, {}, {ILS_W, {-0.2, 0.02}, 1}, {ILS_W, {-0.2, -0.02}, 1}, {}, {ILS_H, {0, -0.2}, 1}, {ILS_H, {0, 0.2}, 1}, {}, {ILS_H, {0.02, 0}, 1}, {ILS_H, {-0.02, 0}, 1}, {}, {ILS_H, {0.02, 0.1}, 1}, {ILS_H, {-0.02, 0.1}, 1}, {}, {ILS_H, {0.02, 0.2}, 1}, {ILS_H, {-0.02, 0.2}, 1}, {}, {ILS_H, {0.02, -0.1}, 1}, {ILS_H, {-0.02, -0.1}, 1}, {}, {ILS_H, {0.02, -0.2}, 1}, {ILS_H, {-0.02, -0.2}, 1}, {}};
							};
						};
					};
				};
