...
class CfgWeapons
{
	...
	AGM_Backblast_Angle = 60; // angle of the backblast area
		...
		{
			begin1[] = {"\Trixie_Launchers\sound\smaw_fire",1.9952624,1,1000};
			soundBegin[] = {"begin1",1};
		};
		drySound[] = {"A3\sounds_f\weapons\other\dry6",0.0001,1,10};
		reloadMagazineSound[] = {"\a3\sounds_f\weapons\Launcher\titan_reload_final",0.00031622776,1,20};
		soundFly[] = {"\a3\sounds_f\weapons\Rockets\rocket_fly_1",10,1.8,300};
	};
