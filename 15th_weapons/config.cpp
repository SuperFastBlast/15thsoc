...
class Extended_PostInit_EventHandlers
{
	class PREFIX
	{
		//clientInit = QUOTE(call COMPILE_FILE2(\15th_weapons\player_init.sqf));

		//serverInit = QUOTE(call COMPILE_FILE2(\15th_weapons\server_init.sqf));
	};
};
