...
==================================================================================================================
  ...
  updated for 15th 3M by Fight9 - edits outlined
...
_nodelay = false;
//----------- Fight9 Edit
_unit setVariable ["TopheRespawn",true,true];
//----------- Fight9 Edit End
...
//	_unit call compile format ["%1=_This; PublicVariable '%1'",_unitname];
	_var = [_unit,_unitname] call bis_fnc_objectvar;
	//------------ Fight9 Edit End
};
...
//----------- Fight9 Edit
_unit setVariable ["TopheRespawnEnd",true,true];
//----------- Fight9 Edit End