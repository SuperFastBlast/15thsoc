...
#define DEFAULT_FIELDREPAIR_EACH_PART_TIME 120
#define DEFAULT_FIELDREPAIR_EACH_HARDPART_TIME 180
#define DEFAULT_FULLREPAIR_LENGTH 360
#define DEFAULT_REPAIR_TRUCK_USES 5
#define DEFAULT_FREE_REPAIRS 0
