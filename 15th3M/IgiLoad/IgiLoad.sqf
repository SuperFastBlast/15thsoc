...
//																											//
//	USE:																									//
//	1. In mission "init.sqf" add line: "0 = execVM "15th3M\IgiLoad\IgiLoadInit.sqf";".								//
//	2. In vehicles "INITIALIZATION" field type: "0 = [this] execVM "15th3M\IgiLoad\IgiLoad.sqf";"					//
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Eject</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Unload ALL cargo with parachute</t>",
	{
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Drop_ATL) && (_target animationPhase 'ramp_bottom' > 0.9) && (_target getVariable 'usable_ramp')"
	...
	{
		_obj_main addAction [
		"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on C-130J</t>",
		{
		...
		_obj_main addAction [
		"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on C-130J</t>",
		{
		...
		_obj_main addAction [
		"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from C-130J</t>",
		{
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on right MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from right MH-9</t>",
	{ 
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from Offroad</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from VAN</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from ZAMAK</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='15th3M\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from HEMTT</t>",
	{
