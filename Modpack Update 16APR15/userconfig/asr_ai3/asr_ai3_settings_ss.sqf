...
asr_ai3_main_onteamswitch	= 1;		// Teamswitch handler: makes unit switched into the group leader and disables fatigue for AI units in player's group (0 - disabled, 1 - enabled)
						// prevents AI left in place from sending stupid orders and enables them to keep up with the player
...
asr_ai3_main_sets = [ // for each level: skilltype, [<min value>, <random value added to min>]
	...
	[	"general",[0.90,0.1],	"aiming",[0.35,0.1],	"spotting",[0.40,0.1]	],	// 1:  sf 1
	[	"general",[0.85,0.1],	"aiming",[0.30,0.1],	"spotting",[0.35,0.1]	],	// 2:  sf 2 (recon units, divers and spotters)
	...
	[	"general",[0.70,0.1],	"aiming",[0.15,0.1],	"spotting",[0.30,0.1]	],	// 9:  pilot 2 (insurgent)
