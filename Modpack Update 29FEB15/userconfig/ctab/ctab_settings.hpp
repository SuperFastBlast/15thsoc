class cTab_settings {
	cTab_vehicleClass_has_FBCB2[] = {"DAR_HMMWV_Base","DAR_MTVRBase","DAR_MaxxPro_Base","MRAP_01_base_F","MRAP_02_base_F","MRAP_03_base_F","Wheeled_APC_F","Tank","Truck_01_base_F","Truck_03_base_F"};
