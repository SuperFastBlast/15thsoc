...
_crate addAction ["<t color=""#DB3503"">" + ("M27 AR Loadout") + "</t>","\meu_ammoBoxes\inf\meu_ar-iar_loadout.sqf"];
_crate addAction ["<t color=""#DB3503"">" + ("M27 AAR") + "</t>","\meu_ammoBoxes\inf\meu_aar-iar_loadout.sqf"];
